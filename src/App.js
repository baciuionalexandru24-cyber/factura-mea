...
const newsFeed = [
  { date: "Actualizat periodic", category: "E-FACTURA", title: "Actualizări privind sistemul RO e-Factura", description: "Urmărește comunicările oficiale ANAF pentru modificări privind facturarea electronică și regulile aplicabile documentelor fiscale.", link: "https://www.anaf.ro/anaf/internet/ANAF/despre_ANAF/informatii_publice/comunicate/", sursa: "anaf.ro" },
  { date: "Actualizat periodic", category: "TARIFE", title: "Actualizări privind tarifele reglementate de energie electrică", description: "Tarifele de distribuție, transport și alte componente reglementate se pot modifica prin ordine ANRE. Verifică sursele oficiale înainte de a lua decizii.", link: "https://anre.ro/energie-electrica/legislatie/tarife-reglementate/", sursa: "anre.ro" },
  { date: "Actualizat periodic", category: "LEGISLAȚIE", title: "Informații utile despre TVA aplicat energiei electrice", description: "Cota de TVA și regulile fiscale pot influența valoarea finală a facturii. Pentru valori oficiale, consultă legislația fiscală actualizată.", link: "https://www.cdep.ro/", sursa: "cdep.ro" },
  { date: "Actualizat periodic", category: "FURNIZORI", title: "Cum verifici ofertele furnizorilor în POSF/ANRE", description: "Comparatorul POSF/ANRE permite verificarea ofertelor disponibile pentru energia electrică. Compară costul total, nu doar prețul energiei active.", link: "https://posf.ro/comparator?comparatorType=electric", sursa: "posf.ro" },
  { date: "Actualizat periodic", category: "ANRE", title: "Componenta CFD pe factura de energie: ce trebuie verificat", description: "Componenta CFD poate apărea ca element separat pe factură. Verifică valoarea aplicată în factura ta și sursele oficiale ANRE.", link: "https://anre.ro/energie-electrica/legislatie/", sursa: "anre.ro" },
];
